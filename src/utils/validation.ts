...
export function requireAny(payload: any, fields: string[], label?: string): any {
...
export function requireField(payload: any, field: string, label?: string): any {
...
export function validateCoordinates(payload: any) {
